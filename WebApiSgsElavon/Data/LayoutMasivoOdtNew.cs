...
public partial class LayoutMasivoOdtNew
{
    ...
    public DateOnly? FechaAltaSistema2 { get; set; }

    public DateOnly? FechaCierreSistema2 { get; set; }

    public DateOnly? FechaAltaProveedor { get; set; }
}
