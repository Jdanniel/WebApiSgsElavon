...
public partial class BdCargaLayoudMasivo
{
    public int IdCargaLayoudMasivo { get; set; }
    ...
    public string FolioDeTelecargaAmex { get; set; }
    ...
    public string DomicilioAlt { get; set; }
